...
infile = open(r"C:\Users\Louis\Desktop\hw5\hw5\data\small_train.csv")
infile1=read_csv_to_list(infile)

infile2 = open(r"C:\Users\Louis\Desktop\hw5\hw5\data\small_val.csv")
...
new_Alpha=Adagrad_decline(s111,grad_a,alfa,0.1)

new_Beta=Adagrad_decline(sb111,grad,Beta,0.1)
